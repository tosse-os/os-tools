...
<div class="max-w-6xl mx-auto bg-white shadow-sm rounded-lg border border-gray-100 p-8 space-y-6">
  ...
  <form method="GET" action="{{ route('reports.archive') }}" class="grid grid-cols-1 md:grid-cols-5 gap-3 items-end">
    <div>
              ...
              <tbody>
                @foreach($context['reports'] as $report)
                  ...
                  <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 border-b"><div class="truncate max-w-xs">{{ $domain }}</div>
                    <div class="text-xs text-gray-500 uppercase">{{ str_replace('_', ' ', $report->type ?? '—') }}</div></td>
